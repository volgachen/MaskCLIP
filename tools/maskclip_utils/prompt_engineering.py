...
# batman_classes = ['a man in a dark and tight-fitting bodysuit with a black cape', 'a man wearing a hat with a white face'] + bg_classes
...
# car_color_classes = ['white', 'black', 'gray', 'red', 'green', 'blue', 'yellow', 'cyan', 'orange']
