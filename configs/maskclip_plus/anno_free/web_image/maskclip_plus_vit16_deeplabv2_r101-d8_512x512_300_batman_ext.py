...
model = dict(
    ...
    decode_head=dict(
        ...
        text_embeddings_path=f'pretrain/batman_ext_ViT16_clip_text.pth',
...
data = dict(
    samples_per_gpu=4,
    train=dict(img_dir=img_dir, pipeline=train_pipeline, data_name='batman_ext'),
    test=dict(split=f'{img_dir}.txt', data_name='batman_ext')
)